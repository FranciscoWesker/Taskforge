      ...
      <div class="card bg-white dark:bg-gray-800 shadow-2xl border border-gray-200 dark:border-gray-700 animate-slide-up">
        <div class="card-body p-8">
          ...
          <div class="flex flex-col items-center mb-6 space-y-3">
            <div class="h-16 w-16 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 text-white flex items-center justify-center text-2xl font-bold shadow-lg hover-lift">
              TF
            </div>
