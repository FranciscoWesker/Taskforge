    ...
    <section class="py-20 bg-white dark:bg-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="card bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 border border-blue-200 dark:border-blue-700 shadow-lg hover-elevate animate-slide-up">
            <div class="card-body p-6">
              <div class="flex items-start justify-between mb-3">
                ...
                <span class="px-2 py-1 bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded text-xs font-semibold border border-purple-200 dark:border-purple-700">IA</span>
              </div>
              <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Tableros Kanban Inteligentes</h3>
          ...
          <div class="card bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 border border-purple-200 dark:border-purple-700 shadow-lg hover-elevate animate-slide-up">
            <div class="card-body p-6">
              <div class="flex items-start justify-between mb-3">
              ...
              <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Chat en tiempo real</h3>
              <p class="text-gray-700 dark:text-gray-300 mb-3">
          ...
          <div class="card bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/30 dark:to-orange-800/30 border border-orange-200 dark:border-orange-700 shadow-lg hover-elevate animate-slide-up">
            <div class="card-body p-6">
              ...
              <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Integración con GitHub</h3>
          ...
          <div class="card bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 border border-green-200 dark:border-green-700 shadow-lg hover-elevate animate-slide-up">
            <div class="card-body p-6">
              ...
              <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Colaboración en vivo</h3>
              <p class="text-gray-700 dark:text-gray-300">
          ...
          <div class="card bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30 border border-indigo-200 dark:border-indigo-700 shadow-lg hover-elevate animate-slide-up">
            <div class="card-body p-6">
              ...
              <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Autenticación Segura</h3>
              <p class="text-gray-700 dark:text-gray-300">
          ...
          <div class="card bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/30 dark:to-pink-800/30 border border-pink-200 dark:border-pink-700 shadow-lg hover-elevate animate-slide-up">
            <div class="card-body p-6">
              ...
              <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">UI Moderna</h3>
              <p class="text-gray-700 dark:text-gray-300">
        ...
        <div class="text-center mt-12">
          <p class="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
            Impulsado por <span class="font-semibold text-purple-600 dark:text-purple-400">Google Gemini 2.0 Flash</span>. Las funcionalidades de IA trabajan automáticamente, analizando cientos de tareas en segundos para optimizar tu flujo de trabajo de forma que sería imposible hacer manualmente.
          </p>
        </div>
      </div>
    </section>
